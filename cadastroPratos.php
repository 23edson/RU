						...
						<div id="wrapper" style="color: #228B22">
							<div id="login"  class="animate form">
								<form action="upload.php" method="post" enctype="multipart/form-data">
									<header>
										<h1 style="color: #228B22" ><span>Cadastrar Prato</span></h1>
									</header>
									<p>
									...
									<p>
										...
										<select id="inputipo" name="inputipo" placeholder="" required="true">
<?php
										$query = db_select(2,"select id, tipo from TipoPratos");											
										for($i=0; $i<18;$i+=2)
												echo "<option value=".$query[$i].">".$query[$i+1]."</option>";
?>											
										</select>
									</p>
