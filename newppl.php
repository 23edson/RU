	...
	<html  lang="pt-br">
		...
		<body  id="page-login-index">
			...
			<div class="container">
					...
					<div id="container_demo" >
						...
						<div id="wrapper" style="color: #228B22">
							<div id="login"  class="animate form">
								<form action="newpplup.php" method="post" enctype="multipart/form-data">
									<header>
									...
									<p>
										...
										<input type="email" id="inputemail" name="inputemail" placeholder="" required="true"/>
										
									</p>
									<p>
										<label for="inputfunc" style="color: #228B22" data-icon="" >Função</label>
										<select id="inputfunc" name="inputfunc" placeholder="" required="true">
											<option value="f1">Estudante</option>
											<option value="f2">Professor</option>
											<option value="f3">Servidor</option>
										</select>
									</p>
									<p>
										<label for="inputpass" style="color: #228B22" data-icon="" >Criar senha</label>										
										<input type="password" id="inputpass" name="inputpass" placeholder="" required="true"/>
									</p>
				...
				<div id="div3"><p style="text-align:center;">
				<br><br><br>
